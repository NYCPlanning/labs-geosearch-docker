...
const DETAILS_PROPS = [
  ...
  { name: 'pad_low',           type: 'string' },
  { name: 'pad_high',           type: 'string' },
  { name: 'pad_bin',           type: 'string' },
  { name: 'pad_bbl',           type: 'string' },
  { name: 'pad_geomtype',           type: 'string' },
  { name: 'pad_orig_stname',           type: 'string' },
];
